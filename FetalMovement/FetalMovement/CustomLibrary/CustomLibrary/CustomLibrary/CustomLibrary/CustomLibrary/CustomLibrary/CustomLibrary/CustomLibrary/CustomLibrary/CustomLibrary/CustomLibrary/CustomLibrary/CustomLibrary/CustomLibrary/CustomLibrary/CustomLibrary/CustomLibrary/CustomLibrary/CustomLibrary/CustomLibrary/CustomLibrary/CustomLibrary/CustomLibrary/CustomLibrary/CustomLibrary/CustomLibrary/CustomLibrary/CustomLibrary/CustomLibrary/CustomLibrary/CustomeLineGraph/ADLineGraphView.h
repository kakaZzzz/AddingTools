...
@protocol ADLineGraphDelegate <NSObject>
...
/**
 *  The number of points along the X-axis of the bar
 *
 *  @return Number of points.
 */
...
@interface ADLineGraphView : UIView <ADAnimationDelegate, UIGestureRecognizerDelegate>

@property (nonatomic,weak) id <ADLineGraphDelegate> delegate;

@property (strong, nonatomic) ADAnimations *animationDelegate;
